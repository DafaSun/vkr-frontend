            ...
            <div className={styles['content-container']}>
                ...
                <div className={styles['main-container']}>
                    <div className={styles['filters-container']}>
                        ...
                        <div className={styles['row-container']}>
                            <DropdownList options={roomTypesList} label={' Выберите тип размещения'}
                                          text={'Выберите тип размещения из списка'} onSelect={selectRoomType}/>
                            <InputNumber text={'Введите кол-во человек'} onChange={changePeople} min={1} max={100}
                                         label={''}/>
