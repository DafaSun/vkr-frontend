                    ...
                    <div className={styles['room-container']}>
                        ...
                        <div className={styles['room-description']}>
                            ...
                            <Button3 text={'Забронировать'} onClick={() => {
                                navigate(`/manager/tour/tour/rooms-in-category/booking?checkin=${arrivalDate}&checkout=${departureDate}&guests=${people}&roomType=${roomType}&category=${category}&room=${206}`);
                            }}/>
                        </div>
                    </div>
                </div>
