...
const HotelCategoriesManager = () => {
    ...
    const searchClick = async () => {
        try {
            const response = await axios.get(`http://localhost:8000/api/manager/categories/?checkin=${checkin}&checkout=${checkout}&gender=${gender}&guests=${guests}&room_type=${roomType}&tour_type=hotel`);
    ...
    return (
        <div className={styles['page-style']}>
            <SideBar activeItem={"hotel"} items={[
...
export default HotelCategoriesManager;
